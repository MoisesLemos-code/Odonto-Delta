export default {
    ...
    COMUM: {
        ...
        SET_RETRAIR_MENU_MOBILE: 'setRetrairMenuMobile',
        SET_EXPANDIR_MENU_MOBILE: 'setExpandirMenuMobile',
        SET_MENU_MOBILE_ON: 'setMenuMobileOn',
        SET_MENU_MOBILE_OFF: 'setMenuMobileOf',
